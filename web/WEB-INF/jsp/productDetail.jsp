            ...
            <div class="Product">
              ...
              <div class="row">
                ...
                <div id="productDetail" class="col-md-8">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <h2> <b> ${product.getProductName()} </b> </h2>
                        </div>
                        <div class="col-md-4">
                            <a href="../cart/add?productID=${product.getProductID()}"  class="add-to-cart btn btn-danger btn-addLarge"><h4><b>Thêm vào giỏ hàng</b></h4></a> 
                        </div>
                    </div>
                    ...
                    <div class="row well">
                        <div class="col-md-6 img">
                            <img src="${pageContext.request.contextPath}/resources/images/${product.getImage()}" alt="${product.getProductID()}" class="img-detail table-bordered img-responsive"> 
                        </div>
                        ...
                        <div class="col-md-6">
                            <h3>
                                ...
                                <ul>
                                    ...
                                    <li>Giá bán: ${product.getProductPrice()} đ</li>
                                    <li>Hãng sản xuất: ${supplier.setSupplierName()}</li>
                                    <li>Xuất xứ: ${supplier.setSupplierAddress()} </li>
                                </ul>
                            </h3>
                        </div>
                    </div>
