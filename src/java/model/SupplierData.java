...
public class SupplierData {
    ...
    public static String updateSupplier(int SID, String name,String address) throws SQLException {
        
        try {
             
             DbConnect connect = new DbConnect();
             String query = "UPDATE Suppliers "
                     + "SET SName= N'"+name+"', SAddress = N'"+address+"' "
                     + "WHERE (SID='"+SID+"')" ;
...
//        SupplierData.updateSupplier(8, new Supplier(0, "SONY", "Nước Nhật Bản"));
    }
}
