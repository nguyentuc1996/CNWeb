    ...
    public String signUp(HttpServletRequest request, HttpServletResponse response, ModelMap mm) throws IOException {
        ...
        try{
            ...
            if(User.checkUsername(username)) {
                ...
                if(error !=null) {
                   mm.put("script", "<script> alert(' Có lỗi khi gửi mail xác minh! Đăng ký không thành công!');  window.location = '"+request.getContextPath()+"/home' </script>");
          ...
          mm.put("script", "<script> alert('Có lỗi:"+e.getMessage()+" '); </script>");
