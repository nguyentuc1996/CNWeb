...
--
-- Host: localhost
-- Generation Time: May 23, 2017 at 02:46 PM
...
(56, 10, 15980000, 'Đặng ', 'da', 'Chuyển khoản', '2017-05-23 05:37:04');
...
(91, 56, 'sp-galaxys7', 15340000, 1),
(92, 56, 'as-headphone', 640000, 1);
...
--
ALTER TABLE `Bill`
  MODIFY `BillId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
--
-- AUTO_INCREMENT for table `BillDetail`
--
ALTER TABLE `BillDetail`
  MODIFY `BillDetailId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=93;
--
